...
function openEditModal(index, callback, mainContainer) {  
    ...
    var saveBtn = formHtml.find('.save');  
    var cancelBtn = formHtml.find('.cancel');  
    ...
    saveBtn.on('hover:enter', function () {  
        ...
        enableOutsideClose(mainContainer, { onClose: () => Lampa.Controller.toggle('settings_component') });  
    });  
...
function openSourcesModal() {  
    ...
    function renderSources() {  
        ...
        sources.forEach(function (src, index) {  
            ...
            item.find('.multi-btn-edit').on('hover:enter', function () {  
                openEditModal($(this).data('index'), renderSources, container);  
            });  
    ...
    addBtn.on('hover:enter', function () {  
        openAddModal(renderSources, container);  
    });  
